...
export const metadata: Metadata = { title: "Washington airport car service", description: "Advance-reserved executive transfers for DCA, IAD, and BWI with flight-aware coordination." };
...
const airports = [
  ...
  { code: "BWI", name: "Baltimore / Washington", body: "Advance-planned transfers connecting the Baltimore airport with Washington, Maryland, and onward corporate schedules." },
];

export default function AirportsPage() {
  return <>
    <PageHero eyebrow="Airport service" title="The arrival is part of the itinerary." body="Flight-aware coordination for Washington’s three commercial airports, with clear meeting instructions and coverage confirmed before the traveler departs." action={{ label: "Request an airport ride", href: "/book" }} />
